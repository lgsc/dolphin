...
catalog = {'pr-record-de-votacion-de-senado': {'title': 'Record de Votación de Senado',
                                               'json': 'https://data.pr.gov/resource/byvm-x9d7.json',
                                               'link': 'https://data.pr.gov/en/Abierto/Record-de-Votaci-n-de-Senado/fu3e-fj3e'},
           'pr-escuelas-publicas': {'title': 'Directorio Comprensivo de Escuelas Públicas, Puerto Rico 2017',
           ...
           'pr-mapa-de-donaciones-recibidas': {'title': 'Mapa de donaciones recibidas por código postal',
           ...
           'pr-beneficios-de-pan-y-tanf': {'title': 'Estadisticas de Beneficios de PAN y TANF',
           ...
           'pr-mapa-del-crimen': {'title': 'Mapa del Crimen',
